...
function Bleno() {
  ...
  this._bindings.on('centralConnected', this.onCentralConnected.bind(this));
}
...
Bleno.prototype.onCentralConnected = function(){
  debug('onCentralConnected');
  this._bindings.updateRssi(function(rssi){
    debug("GOT RSSI: " + rssi);
  });
}
